...
urlpatterns = [
    ...
    path('dia_hoy/', dia_de_hoy, name='dia_de_hoy'),
    path('saludo_nombre/<nombre>', saludo_con_nombre),
    path('calcula_anio/<edad>', calcula_anio_de_nacimiento),
    path('prueba_html/', probando_html),
]
